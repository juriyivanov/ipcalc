...
**Extended IP Calculator v3.15.1** — это статическое браузерное приложение для базовых операций с IPv4-сетями и MAC-адресами. Оно не требует backend, npm-сборки или внешних runtime-зависимостей.
...
Схема версии приложения: `3.<PR number>.<revision inside PR>`; для этого изменения используется `3.15.1`.
